...
"""
This script sends a POST request to a specified URL with an email as a parameter and prints the email address.
...
Arguments:
    ...
    EMAIL_ADDRESS: The email address to be sent as a parameter in the POST request.
